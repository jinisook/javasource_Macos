        ...
        while (run) {
            ...
            switch (menu) {
                ...
                case 6:
                    ...
                    result = professorService.insertProfessor(professorDTO); // boolaen 타입으로 받음
                ...
                case 10:
                    // 학생입력
                    StudentDTO studentDTO = info.inserStudent(sc);
                ...
                case 14:
                    // 개인별 조회
                    studentId = info.getStudentIdStudent(sc);
